...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        public RectTransform activeGameObject;
        ...
        private bool SendUpdateEventToSelectedObject()
        {
            if (eventSystem.currentSelectedGameObject == null)
                ...
                ;
                //Debug.Log("GAME OBJECT CLICKED   :  " + eventSystem.gameObject.name);
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            activeGameObjectName = "NULL";
            activeGameObject = null;
            //Debug.Log("OVRRAYCASTER  :  " + ovrRaycaster);
            if (ovrRaycaster)
            {
                ...
                activeGameObjectName = raycast.gameObject.name;
                activeGameObject = graphicRect;
                //Debug.Log("GET ACTIVE OBJECT  :  " + raycast.gameObject.name);
                if (graphicRect != null)
                {
